          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              {[
                ...
                {
                  title: "Mail Address",
                  detail: "connect@kmonlinesolutions.com",
                },
              ].map((item, i) => (
                <motion.div
                  key={item.title}
            ...
            >
              ...
              >
                ...
                {status === "success" && (
                  <div className="p-4 border-2 border-ink bg-paper font-slab text-sm text-ink text-center">
                    Thank you! Your message has been sent. We&apos;ll get back to you soon.
                  </div>
                )}
                {status === "error" && (
                  <div className="p-4 border-2 border-ink bg-paper font-slab text-sm text-ink text-center">
                    Something went wrong. Please try again or email us directly at connect@kmonlinesolutions.com.
                  </div>
                )}
                <button
                  type="submit"
